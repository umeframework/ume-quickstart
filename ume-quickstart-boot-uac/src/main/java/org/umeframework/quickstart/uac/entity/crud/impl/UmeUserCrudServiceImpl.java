...
import org.umeframework.quickstart.uac.entity.crud.UmeUserCrudService;
...
public class UmeUserCrudServiceImpl extends org.umeframework.dora.service.BaseDBComponent implements UmeUserCrudService {

    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#create
     */
    @Override
    ...
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#createList
     */
    @Override
    ...
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#createOrUpdate
     */
    @Override
    ...
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#createOrUpdateList
     */
    @Override
    ...
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#update
     */
    @Override
    ...
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#updateList
     */
    @Override
    ...
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#delete
     */
    @Override
    ...
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#deleteList
     */
    @Override
    ...
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#find
     */
    @Override
    ...
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#findList
     */
    @Override
    public List<UmeUserDto> findList(UmeUserDto condition) {
        return getDao().queryForObjectList(UmeUserDto.SQLID.FIND_LIST, condition, UmeUserDto.class);
    }
    
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService#findListLike
     */
    @Override
    public List<UmeUserDto> findListLike(Map<String, String> condition) {
        return getDao().queryForObjectList(UmeUserDto.SQLID.FIND_LIST_LIKE, condition, UmeUserDto.class);
    }
    
    /* (non-Javadoc)
     * 
     * @see org.umeframework.quickstart.uac.entity.crud.impl.UmeUserCrudService
     */
    @Override
