...
import org.umeframework.quickstart.uac.message.MessageConst;
import org.umeframework.quickstart.uac.user.UserManager;
...
public class UserManagerImpl extends BaseDBComponent implements UserManager, MessageConst {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.umeframework.quickstart.uac.user.UserManager#changePassword(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.umeframework.quickstart.uac.user.UserManager#createUser(org.umeframework.quickstart.uac.entity.UmeUserDto)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.umeframework.quickstart.uac.user.UserManager#updateUser(org.umeframework.quickstart.uac.entity.UmeUserDto)
	 */
	@Override
