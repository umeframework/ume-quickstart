...
/**
 * 数据表"UME用户角色关系表"映射的实体类<br>
 *
 * @author Generator
 */
@Entity
@Table(name="UME_USER_ROLE")
@ApiModel(value="UmeUserRoleDto", description="UME用户角色关系表")
public class UmeUserRoleDto implements Serializable {
    ...
    */
    ...
    @NotNull
    @ApiModelProperty(value="用户持有角色ID", name="roleId", required=true)
    ...
    */
    ...
    public boolean equals(Object that) {
        ...
        UmeUserRoleDto other = (UmeUserRoleDto) that;
        return
