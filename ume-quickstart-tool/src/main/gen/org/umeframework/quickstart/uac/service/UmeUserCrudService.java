...
public interface UmeUserCrudService {
     ...
     */
    UmeUserDto find(UmeUserDto criteria);    
    /**
     ...
     */
    List<UmeUserDto> findList(UmeUserDto criteria);
     ...
     * @return - matched entity instance list
     */
    List<UmeUserDto> findListLike(UmeUserDto criteria);
     ...
     * @return - matched entity instance list
     */
    Integer count(UmeUserDto criteria);
