...
public interface UmeUserRoleCrudService {
     ...
     */
    UmeUserRoleDto find(UmeUserRoleDto criteria);    
    /**
     ...
     */
    List<UmeUserRoleDto> findList(UmeUserRoleDto criteria);
     ...
     * @return - matched entity instance list
     */
    List<UmeUserRoleDto> findListLike(UmeUserRoleDto criteria);
     ...
     * @return - matched entity instance list
     */
    Integer count(UmeUserRoleDto criteria);
