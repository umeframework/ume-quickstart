 ...
 */
@CrossOrigin
@Api(value="UME用户表Controller",tags={"UME用户表 CRUD API"})
@RequestMapping(value = "/api/entity/umeuser/v1/")
@RestController
//@Slf4j
public class UmeUserCrudController {
    /**
     * UmeUserCrudService 实例<br>
     */
    @Resource
    private UmeUserCrudService service;
     ...
     * @param entity
     */
    public void doValidate(UmeUserDto entity) {
        Validator validator = validatorFactory.getValidator();
        Iterator<ConstraintViolation<UmeUserDto>> violations = validator.validate(entity).iterator();
        StringBuilder msg = new StringBuilder();
        while (violations.hasNext()) {
            ConstraintViolation<UmeUserDto> violation = violations.next();
